...
label {
  --bgPlanetBright: #f2c94c;
  --bgPlanetShadow: #828894;
  --bgPlanetLightshadow: #d7d7d820;
}
...
label {
  ...
  .planet {
    ...
    border-radius: 50%;
    overflow: hidden;
    background-color: var(--bgPlanetBright);
    ...
    &::after {
      content: "";
      background-color: var(--bgPlanetShadow);
      width: 2rem;
      height: 2rem;
      position: absolute;
      border-radius: 50%;
